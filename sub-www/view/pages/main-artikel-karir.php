<div class="row justify-content-center">
      <?php if(!empty($data)) {?>
        <div class="col-sm-8">
          <div class="justify-content-start">
            ...
            <p class="text-muted text-center" style="margin-top:-15px"><small><?= FormatTgl($data['tgl_publish'],"3digit-id") ?></small></p>
            <div class="text-center img-container">
              <img style="background: #212C3C;" class="img-fluid" src="<?php echo $data["header_konten"]; ?>">
            </div>
      ...
      <?php }else{ ?>
        <div class="col-sm-12">
          <div class="justify-content-start">
            <h4 class="border-bottom pb-2">Saat ini, lowongan belum tersedia</h4>
          </div>
        </div>
      <?php }?>
    </div>