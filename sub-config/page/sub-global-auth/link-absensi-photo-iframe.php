...
<html lang="en-us">
    ...
    <body class="o-page " id="body" logdata="" iframe="allow" style="background-color: #f5f9fb;">

        <div id="absensi_photo_iframe" style="padding-top: 0px;padding-left: 0px;"><img src="img-check.png"></div>
