        ...
        <div class="o-page__card u-width-100">
            <div class="c-card u-m-xsmallz">
                <header class="c-card__header u-p-small">
                    ...
                    <div class="u-h3 u-text-center u-m-zero" style="line-height: 1;">WA SYNC </div>
                ...
                <!-- <div class="row">
                    <div class="col-6 u-text-right u-p-xsmall">PESAN</div>
                    <div class="col-6 u-text-left u-p-xsmall">BERKAS</div>
                </div> -->

                <div class="row">
                    <div class="col u-text-center u-p-xsmall" id="progress_sync"><img src="img-check.png" style="margin-right:5px;"></div>
                    <!-- <div class="col-6 u-text-left u-p-xsmall" id="progress_sync_file"><img src="img-check.png" style="margin-right:5px;"></div> -->
                </div>
            ...
            <div class="o-line u-justify-center">
                ...
                $idwa_worker    = array();
                while($mfa=mysqli_fetch_array($mqr)){ array_push($idwa_worker,$mfa["idwa"]); };
                ?>
                <input type="hidden" id="wa_sync"           value="1">
